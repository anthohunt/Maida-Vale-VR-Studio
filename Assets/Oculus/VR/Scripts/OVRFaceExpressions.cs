...
public class OVRFaceExpressions : MonoBehaviour, IReadOnlyCollection<float>
{
  ...
  //  public float max;
    ...
    private void Update()
    {
        ...
        if(ValidExpressions)
        {
            browLowererL = this[FaceExpression.BrowLowererL];
            browLowererR = this[FaceExpression.BrowLowererR];
            cheekPuffL = this[FaceExpression.CheekPuffL];
            cheekPuffR = this[FaceExpression.CheekPuffR];
            cheekRaiserL = this[FaceExpression.CheekRaiserL];
            cheekRaiserR = this[FaceExpression.CheekRaiserR];
            cheekSuckL = this[FaceExpression.CheekSuckL];
            cheekSuckR = this[FaceExpression.CheekSuckR];
            chinRaiserB = this[FaceExpression.ChinRaiserB];
            chinRaiserT = this[FaceExpression.ChinRaiserT];
            dimplerL = this[FaceExpression.DimplerL];
            dimplerR = this[FaceExpression.DimplerR];
            eyesClosedL = this[FaceExpression.EyesClosedL];
            eyesClosedR = this[FaceExpression.EyesClosedR];
            eyesLookDownL = this[FaceExpression.EyesLookDownL];
            eyesLookDownR = this[FaceExpression.EyesLookDownR];
            eyesLookLeftL = this[FaceExpression.EyesLookLeftL];
            eyesLookLeftR = this[FaceExpression.EyesLookLeftR];
            eyesLookRightL = this[FaceExpression.EyesLookRightL];
            eyesLookRightR = this[FaceExpression.EyesLookRightR];
            eyesLookUpL = this[FaceExpression.EyesLookUpL];
            eyesLookUpR = this[FaceExpression.EyesLookUpR];
            innerBrowRaiserL = this[FaceExpression.InnerBrowRaiserL];
            innerBrowRaiserR = this[FaceExpression.InnerBrowRaiserR];
            jawDrop = this[FaceExpression.JawDrop];
            jawSidewaysLeft = this[FaceExpression.JawSidewaysLeft];
            jawSidewaysRight = this[FaceExpression.JawSidewaysRight];
            jawThrust = this[FaceExpression.JawThrust];
            lidTightenerL = this[FaceExpression.LidTightenerL];
            lidTightenerR = this[FaceExpression.LidTightenerR];
            lipCornerDepressorL = this[FaceExpression.LipCornerDepressorL];
            lipCornerDepressorR = this[FaceExpression.LipCornerDepressorR];
            lipCornerPullerL = this[FaceExpression.LipCornerPullerL];
            lipCornerPullerR = this[FaceExpression.LipCornerPullerR];
            lipFunnelerLB = this[FaceExpression.LipFunnelerLB];
            lipFunnelerLT = this[FaceExpression.LipFunnelerLT];
            lipFunnelerRB = this[FaceExpression.LipFunnelerRB];
            lipFunnelerRT = this[FaceExpression.LipFunnelerRT];
            lipPressorL = this[FaceExpression.LipPressorL];
            lipPressorR = this[FaceExpression.LipPressorR];
            lipPuckerL = this[FaceExpression.LipPuckerL];
            lipPuckerR = this[FaceExpression.LipPuckerR];
            lipStretcherL = this[FaceExpression.LipStretcherL];
            lipStretcherR = this[FaceExpression.LipStretcherR];
            lipSuckLB = this[FaceExpression.LipSuckLB];
            lipSuckLT = this[FaceExpression.LipSuckLT];
            lipSuckRB = this[FaceExpression.LipSuckRB];
            lipSuckRT = this[FaceExpression.LipSuckRT];
            lipTightenerL = this[FaceExpression.LipTightenerL];
            lipTightenerR = this[FaceExpression.LipTightenerR];
            lipsToward = this[FaceExpression.LipsToward];
            lowerLipDepressorL = this[FaceExpression.LowerLipDepressorL];
            lowerLipDepressorR = this[FaceExpression.LowerLipDepressorR];
            mouthLeft = this[FaceExpression.MouthLeft];
            mouthRight = this[FaceExpression.MouthRight];
            noseWrinklerL = this[FaceExpression.NoseWrinklerL];
            noseWrinklerR = this[FaceExpression.NoseWrinklerR];
            outerBrowRaiserL = this[FaceExpression.OuterBrowRaiserL];
            outerBrowRaiserR = this[FaceExpression.OuterBrowRaiserR];
            upperLidRaiserL = this[FaceExpression.UpperLidRaiserL];
            upperLidRaiserR = this[FaceExpression.UpperLidRaiserR];
            upperLipRaiserL = this[FaceExpression.UpperLipRaiserL];
            upperLipRaiserR = this[FaceExpression.UpperLipRaiserR];
           // max = this[FaceExpression.Max];
        }
    }
