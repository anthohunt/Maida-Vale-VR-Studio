...
namespace Oculus.Avatar2
{
    ...
    public partial class OvrAvatarEntity : MonoBehaviour
    {
        ...
        // Tracking
        //edited by Anthony 27/03/2023, private to public
        [Header("Tracking Input")]
        [SerializeField]
        public OvrAvatarBodyTrackingBehavior _bodyTracking;

        [FormerlySerializedAs("_faceTrackingBehavior")]
        [SerializeField]
        public OvrAvatarFacePoseBehavior _facePoseBehavior;

        [FormerlySerializedAs("_eyeTrackingBehavior")]
        [SerializeField]
        public OvrAvatarEyePoseBehavior _eyePoseBehavior;

        [SerializeField]
        public OvrAvatarLipSyncBehavior _lipSync;
...
#pragma warning restore 618
        ...
        //Anthony edit, to update the tracking via an external script for an experiment
        public void CustomUpdateAvatarTracking()
        {
            // Allows the tracking to up updated in the editor.
            SetBodyTracking(_bodyTracking);
